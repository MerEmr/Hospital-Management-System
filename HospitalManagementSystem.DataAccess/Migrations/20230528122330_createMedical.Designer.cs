...
namespace HospitalManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20230528122330_createMedical")]
    partial class createMedical
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.Medical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.Medical", b =>
                {
                    b.HasOne("HospitalManagementSystem.Entities.Concrete.User", "User")
                        .WithOne("Medical")
                        .HasForeignKey("HospitalManagementSystem.Entities.Concrete.Medical", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
