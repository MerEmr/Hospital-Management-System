...
namespace HospitalManagementSystem.DataAccess.Migrations
{
    ...
    [Migration("20230428160317_updateModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.Appointment", b =>
                {
                    ...
                    b.Property<int>("UserDoctorMappingId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserDoctorMappingId");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.UserDoctorMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserDoctorMapping");
                });

            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.Appointment", b =>
                {
                    b.HasOne("HospitalManagementSystem.Entities.Concrete.UserDoctorMapping", "UserDoctorMapping")
                        .WithMany("Appointments")
                        .HasForeignKey("UserDoctorMappingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserDoctorMapping");
                });
            ...
            modelBuilder.Entity("HospitalManagementSystem.Entities.Concrete.Record", b =>
                {
                    b.HasOne("HospitalManagementSystem.Entities.Concrete.User", "User")
                        .WithOne("Record")
                        .HasForeignKey("HospitalManagementSystem.Entities.Concrete.Record", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
